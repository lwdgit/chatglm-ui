...
import { IconPlayerStop, IconRepeat, IconSend, IconDots } from '@tabler/icons-react';
import {
  FC,
  KeyboardEvent,
  MutableRefObject,
      ...
      <div className="stretch mx-2 mt-4 flex flex-row gap-3 last:mb-2 md:mx-4 md:mt-[52px] md:last:mb-6 lg:mx-auto lg:max-w-3xl">
        ...
        <div className="relative flex w-full flex-grow flex-col rounded-md border border-black/10 bg-white py-2 shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:border-gray-900/50 dark:bg-[#40414F] dark:text-white dark:shadow-[0_0_15px_rgba(0,0,0,0.10)] md:py-3 md:pl-4">
          ...
          <button
            ...
            onClick={handleSend}
          >
            {messageIsStreaming ? <IconDots size={16} className="animate-pulse opacity-60" /> : <IconSend size={16} className="opacity-60" />}
          </button>
        </div>
      </div>
